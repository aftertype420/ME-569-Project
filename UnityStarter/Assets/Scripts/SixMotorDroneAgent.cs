...
public class SixMotorDroneAgent : Agent
{
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        ...
        sensor.AddObservation(ClampVector(rb.velocity / Mathf.Max(maxSpeed, 0.001f)));
    ...
    private void ApplyStepReward()
    {
        ...
        float velocityPenalty = Mathf.Clamp01(rb.velocity.magnitude / Mathf.Max(maxSpeed, 0.001f));
        ...
        if (positionError < 0.35f && rb.velocity.magnitude < 0.5f)
        {
